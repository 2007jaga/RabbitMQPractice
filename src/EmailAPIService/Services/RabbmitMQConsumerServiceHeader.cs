...
public class RabbitMQConsumerServiceHeader : BackgroundService
{
    private int _processedMessageCount = 0;
    private readonly EmailService _emailService;
    private readonly ConsumerSettings _consumerSettings;
 
    public RabbitMQConsumerServiceHeader(EmailService emailService, IOptions<ConsumerSettings> consumerOptions )
    {
