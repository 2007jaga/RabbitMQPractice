...
public class RabbitMQConsumerServiceTopic: BackgroundService
{
    private int _processedMessageCount = 0;
    private readonly EmailService _emailService;
    private readonly ConsumerSettings _consumerSettings;
    public RabbitMQConsumerServiceTopic(EmailService emailService, IOptions<ConsumerSettings> consumerOptions)
    {
