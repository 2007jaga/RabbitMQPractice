...
public class RabbitMQConsumerServiceFanout : BackgroundService
{
    private int _processedMessageCount = 0;
    private readonly EmailService _emailService;
    private readonly ConsumerSettings _consumerSettings;
    public RabbitMQConsumerServiceFanout(EmailService emailService, IOptions<ConsumerSettings> consumerOptions)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        // this is use for how much number of queue we need to pass at one shot to the consumer 
